class Spree::TaxonBanner < ActiveRecord::Base
  ...
  has_attached_file :desktop_size_de, default_url: "/images/:style/missing.png"
  validates_attachment_content_type :desktop_size, content_type: /\Aimage\/.*\z/
  has_attached_file :tablet_size_de, default_url: "/images/:style/missing.png"
  validates_attachment_content_type :tablet_size, content_type: /\Aimage\/.*\z/
  has_attached_file :mobile_size_de, default_url: "/images/:style/missing.png"
  validates_attachment_content_type :mobile_size, content_type: /\Aimage\/.*\z/

  has_attached_file :desktop_size_en, default_url: "/images/:style/missing.png"
  validates_attachment_content_type :desktop_size, content_type: /\Aimage\/.*\z/
  has_attached_file :tablet_size_en, default_url: "/images/:style/missing.png"
  validates_attachment_content_type :tablet_size, content_type: /\Aimage\/.*\z/
  has_attached_file :mobile_size_en, default_url: "/images/:style/missing.png"
  validates_attachment_content_type :mobile_size, content_type: /\Aimage\/.*\z/
end
